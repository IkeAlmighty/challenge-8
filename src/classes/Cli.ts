...
class Cli {
  ...
  createTruck(): void {
    inquirer
      ...
      .then((answers) => {
        const wheels: Wheel[] = []; // letting the truck contructor create wheels
  ...
  createMotorbike(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        const wheels = [
          new Wheel(frontWheelDiameter, frontWheelBrand),
  ...
  findVehicleToTow(truck: Truck): void {
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        // throw an error if the find doesn't work
        if (!selectedVehicle) throw Error(`Critical Error: could not find a vehicle with vin ${answers.vehicleToTow.vin}`);
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        // add statements to perform the wheelie action only if the selected vehicle is a motorbike
          ...
          let selectedBike: Motorbike | undefined;
